const activateMail = (fullname, token) => {
    return (`
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      <!--[if (mso)|(IE)]><td align="center" width="550" style="background-color: #132f40;width: 550px;padding: 0px;border-top: 0px solid transparent;border-left: 0px solid transparent;border-right: 0px solid transparent;border-bottom: 0px solid transparent;" valign="top"><![endif]-->
                      <div
                        class="u-col u-col-100"
                        style="
                          max-width: 320px;
                                    ...
                                    >
                                      ...
                                      <ol>
                                        <li style="line-height: 25.2px">
                                          Buy Products at discounted price.
                                        </li>
                                        <li style="line-height: 25.2px">
                                          Publish your honest review about the
                                          product you purchased.
                                        </li>
                                        <li style="line-height: 25.2px">
                                          Priority customer support for all your
                                          inquiries.
                                        </li>
                                      </ol>
                                    </div>
                                        ...
                                        <strong
                                          ><span
                                            style="
                                              ...
                                              line-height: 22.4px;
                                            "
                                            >Thanks so much for joining with
                                            us! </span
                                          ></strong
                                        ><span
                                          style="
                                ...
                                <tr>
                                  ...
                                  >
                                    ...
                                    <div class="v-text-align" align="center">
                                      <!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="" style="height:36px; v-text-anchor:middle; width:200px;" arcsize="55.5%"  strokecolor="#f1c40f" strokeweight="2px" fillcolor="#2dc26b"><w:anchorlock/><center style="color:#FFFFFF;"><![endif]-->
                                      <a
                                        href="${process.env.CORS_URL}/verify/${token}"
                                        target="_blank"
                                        class="v-button"
                                        style="
                                          box-sizing: border-box;
